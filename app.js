...
mongoose.connect("mongodb+srv://abhirami:aamx@cluster0.kfzrqo8.mongodb.net/project?retryWrites=true&w=majority&appName=Cluster0").then(()=>{
...
try{
    ...
    res.send({message:"item delected"})
